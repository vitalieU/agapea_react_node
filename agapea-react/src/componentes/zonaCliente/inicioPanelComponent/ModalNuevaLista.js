...
export default function ModalNuevaLista() {
    ...
    async function handleClickGuardar(ev){
        ...
        if(resp.codigo===0){
            ...
            window.bootstrap.Modal.getOrCreateInstance(document.getElementById('modalNuevaLista2')).hide();
          }
    }
 return(

<div class="modal fade" id="modalNuevaLista2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
